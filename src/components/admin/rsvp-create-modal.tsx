...
interface RSVPCreateModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  onCreated: () => void
}

export function RSVPCreateModal({ open, onOpenChange, onCreated }: RSVPCreateModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: 'RSVP entry created successfully',
      })
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Create New RSVP Entry</DialogTitle>
          <DialogDescription>
            Add a new guest and their RSVP information
          </DialogDescription>
        </DialogHeader>
